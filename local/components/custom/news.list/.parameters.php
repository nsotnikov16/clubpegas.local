...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		'NEWS_COUNT_MOBILE' => array(
			"PARENT" => "BASE",
			"NAME" => 'Количество новостей на странице мобильного устройства',
			"TYPE" => "STRING",
			"DEFAULT" => "6",
		),
		"HIDE_BLOCK_ID" => array(
			"PARENT" => "BASE",
			"NAME" => 'ID блока, где находится компонент',
			"TYPE" => "STRING",
			"DEFAULT" => "girls",
		),
		'TITLE_BLOCK' => array(
			"PARENT" => "BASE",
			"NAME" => 'Заголовок блока компонента',
			"TYPE" => "STRING",
		),
		'SUBTITLE_BLOCK' => array(
			"PARENT" => "BASE",
			"NAME" => 'Подзаголовок блока компонента',
			"TYPE" => "STRING",
		),
		"SORT_BY1" => array(
			"PARENT" => "DATA_SOURCE",
