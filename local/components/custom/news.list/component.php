...
if ($arParams['NEWS_COUNT_MOBILE'] <= 0) $arParams['NEWS_COUNT_MOBILE'] = 5;
...
if ($arParams["DISPLAY_TOP_PAGER"] || $arParams["DISPLAY_BOTTOM_PAGER"]) {
	$arNavParams = array(
		"nPageSize" => $_COOKIE['isMobile'] == 'true' ? $arParams["NEWS_COUNT_MOBILE"] : $arParams["NEWS_COUNT"],
	...
	$arNavParams = array(
		"nTopCount" => $_COOKIE['isMobile'] == 'true' ? $arParams["NEWS_COUNT_MOBILE"] : $arParams["NEWS_COUNT"],
		"bDescPageNumbering" => $arParams["PAGER_DESC_NUMBERING"],
	);
	$arNavigation = false;
}
